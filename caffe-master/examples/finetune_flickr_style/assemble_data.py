...
example_dirname = os.path.abspath(os.path.dirname(__file__)) #返回当前文件的绝对路径(跟脚本运行的路径有关) 
...
if __name__ == '__main__':  
    ...
    csv_filename = os.path.join(example_dirname, 'flickr_style.csv.gz') # 字符串(路径)拼接，中间添加\ 
